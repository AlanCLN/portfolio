...
const Portfolio = ({title, thumb, featuredVideo, videoLink, sourceLink, description}) => {
    ...
    return (
        <>
            <div
                className={`relative duration-400 hover:drop-shadow-portfolio ${featuredVideo ? bgOverlay : ""}`}
            >
                ...
                <p className="sm:pt-5">{description}</p>
                {/* </Link> */}
                {featuredVideo && (
                    <button
